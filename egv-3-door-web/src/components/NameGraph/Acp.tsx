...
const AcpGraph = (props: Props) => {
    ...
    const dataAcpMain = allData ? allData.map((item) => item.acpMain ? item.acpMain : null) : []
    const dataAcpSub = allData ? allData.map((item) => item.acpSub ? item.acpSub : null) : []
